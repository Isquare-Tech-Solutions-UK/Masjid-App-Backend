...
public interface AnnouncementService {
    ...
    AnnouncementResponse updateAnnouncement(UUID announcementId, UpdateAnnouncementRequest request, AdminUser updatedBy,
            String ipAddress, String userAgent);

    Page<AnnouncementResponse> getAdminAnnouncements(String status, LocalDateTime startDate, LocalDateTime endDate,
            String search, Pageable pageable);

    Page<AnnouncementResponse> getMemberAnnouncements(LocalDateTime startDate, LocalDateTime endDate,
            Pageable pageable);
    ...
    AnnouncementResponse changeAnnouncementStatus(UUID announcementId, String statusRaw, AdminUser updatedBy,
            String ipAddress, String userAgent);
